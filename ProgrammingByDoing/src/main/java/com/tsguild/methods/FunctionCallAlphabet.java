...
public class FunctionCallAlphabet {
    public static void main( String[] args )
	{
		...
		f("foo");    // displays the word you pass it beginning with "F"
		...
		n("No");    // displays the word you pass it beginning with "N"
		...
		t("Tame");    // displays the word you pass it beginning with "T"
