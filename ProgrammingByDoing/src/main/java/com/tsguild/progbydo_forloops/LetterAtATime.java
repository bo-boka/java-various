...
public class LetterAtATime {
	...
	}//adding the eQuals sign loops again when there isn't a character there and crashes
        //it's length is 3 but the position of the last character is 2 because indexes start at 0 instead of 1
        // <= doesn't account for the index 0
