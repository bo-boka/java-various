...
public class Swimming {
    ...
    // They swim for the same amount of time when the water temp is 80.5
    // At temp 78, Gallant doesn't swim but Goofus swims for a min.
    // Goofus dives right in
    // A do-while loop executes at least one time, then checks the condition before executing again whereas a while loop checks the condition first
    // Pretest loop is a while loop; posttest loop is do-while
}
