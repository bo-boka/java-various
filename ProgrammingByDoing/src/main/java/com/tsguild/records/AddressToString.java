...
// THE ABOVE CODE WAS ADDED TO THE ADDRESS CLASS ALREADY MADE IN WEBADDRESSES ASSIGNMENT
// taking away the toString() method prints out the location and the item id# instead of the values
